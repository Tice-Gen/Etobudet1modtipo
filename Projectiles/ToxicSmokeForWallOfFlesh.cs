...
{
    public class ToxicSmokeForWallOfFlesh : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                Color innerGlow = new Color(255, 140, 30) * (0.45f * progress);
                Color outerGlow = new Color(255, 170, 60) * (0.22f * progress);
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool(6))
            {
                ...
                Main.dust[blood].velocity *= 0.6f;


                Main.dust[blood].color = new Color(120, 20, 20);
            }
