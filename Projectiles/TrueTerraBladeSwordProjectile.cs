...
namespace Etobudet1modtipo.Projectiles
{
    ...
    public class TrueTerraBladeSwordProjectile : ModProjectile
    {
        ...
        public override void AI() {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity) {
                ...
                Color dustColor = Color.Lerp(Color.Turquoise, Color.LimeGreen, Main.rand.NextFloat());
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity) {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, Color.Aquamarine * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Color backDarkColor = new Color(0, 150, 120);
            Color middleMediumColor = new Color(40, 255, 180);
            Color frontLightColor = new Color(180, 255, 230);
