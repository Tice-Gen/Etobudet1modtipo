...
{
    public class PoisonKnifeStorm : ModItem
    {
        ...
        {
            tooltips.Add(new TooltipLine(Mod, "PoisonKnifeStormDesc", Terraria.Localization.Language.GetTextValue("Mods.Etobudet1modtipo.ItemTooltips.PoisonKnifeStorm.PoisonKnifeStormDesc")));
        }
