...
namespace Etobudet1modtipo.items
{
    public class ChlorophyteYoyo : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.channel = true;
            Item.shoot = ModContent.ProjectileType<ChlorophyteYoyoProj>();
            Item.shootSpeed = 16f;
        }
        ...
        {
            tooltips.Add(new TooltipLine(Mod, "Description", Terraria.Localization.Language.GetTextValue("Deadly shards orbit the yoyo in a ring.\nRelease the attack button to send the shards flying outward.\nOver time, it builds up more and more shards.\nPierces armor insanely well.")));
