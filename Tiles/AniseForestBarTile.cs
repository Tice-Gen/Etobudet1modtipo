...
{
	public class AniseForestBarTile : ModTile
	{
		public override void SetStaticDefaults() {
			...
			RegisterItemDrop(ModContent.ItemType<AniseForestBar>());

			AddMapEntry(new Color(191, 225, 81), Language.GetText("AniseForestBar"));
		}
