...
{
	public class FloweringChlorophyteBarTile : ModTile
	{
		public override void SetStaticDefaults() {
			...
			RegisterItemDrop(ModContent.ItemType<FloweringChlorophyteBar>());

			AddMapEntry(new Color(118, 150, 0), Language.GetText("FloweringChlorophyteBar"));
		}
